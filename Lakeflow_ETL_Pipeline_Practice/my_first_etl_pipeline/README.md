...
This folder defines all source code for the 'my_first_etl_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_my_first_etl_pipeline.py" to get familiar with the syntax.
